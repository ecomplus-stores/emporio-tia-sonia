...
storefront.on('widget:@ecomplus/widget-tag-manager', () => {
  setTimeout(() => {
      ...
      const $money =  `<div id="dinheiro-volta"><span><strong>Ganhe</strong> <span class="dinheiro">R$ <strong id="changeMoney">${transformToMoney} / (${points} Pontos)</strong></span> <br> em cashback na sua próxima compra</span></div>`
