...
storefront.on('widget:@ecomplus/widget-tag-manager', () => {
  setTimeout(() => {
      if($('#cart').length) {
        ...
        const $money =  `<div id="dinheiro-volta"><span><strong>Ganhe</strong> <span class="dinheiro"> <strong id="changeMoney">${new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(transformToMoney)}</strong></span> <br> em cashback na sua próxima compra</span></div>`
