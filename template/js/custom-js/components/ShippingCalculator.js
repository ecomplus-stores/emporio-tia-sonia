            ...
            return priceDiff < 0
              ...
              : priceDiff > 0
                ...
                : a.shipping_line.delivery_time && b.shipping_line.delivery_time &&
                  (a.shipping_line.delivery_time.days + (a.shipping_line.posting_deadline.days || 0)) < (b.shipping_line.delivery_time.days + (b.shipping_line.posting_deadline.days || 0))
                  ? -1
                  : 1
          })
